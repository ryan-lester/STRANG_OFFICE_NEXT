...
const IMAGES = [
    `${CF_URL}/bts/STRANG_BTS-1.jpg`,
    `${CF_URL}/bts/STRANG_BTS-2.jpg`,
    `${CF_URL}/bts/STRANG_BTS-3.jpg`,
    `${CF_URL}/bts/STRANG_BTS-4.jpg`,
    `${CF_URL}/bts/STRANG_BTS-5.jpg`,
    `${CF_URL}/bts/STRANG_BTS-6.jpg`,
    `${CF_URL}/bts/STRANG_BTS-7.jpg`,

];

export default function BTS_1() {
