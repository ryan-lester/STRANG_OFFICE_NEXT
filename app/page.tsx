...
const MASTER_SCENES = [
    { id: "rock_house_video", name: "Rock House Video", duration: 154000, component: RockHouseVideo, theme: "dark" },
...
function DisplayManager() {
    ...
    const handleGenerate = () => {
        ...
        // --- FULL SCREEN REQUEST REMOVED FROM HERE ---
        // The display will no longer automatically go full screen on launch.
